...
public class RTSliderView extends JPanel {
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    // your code here
	    // Update the model's base value with the slider's current value
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    // your code here
	    // Update the model's height value with the slider's current value
	...
	public void propertyChange(final PropertyChangeEvent evt) {
	    ...
	    // Update the base slider with the model's base value
	    RTSliderView.this.baseSlider.setValue((int) RTSliderView.this.model.getBase());

	    // Update the height slider with the model's height value
